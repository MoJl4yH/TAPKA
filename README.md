...
<p align="center">
  <img src="ui/87288873-75ab-4871-bf62-f126ff451e6c.png" alt="TAPKA Logo" width="200"/>
</p>

**TAPKA** — инструментальная система для автоматизированного анализа Android-приложений на предмет уязвимостей и недекларированных возможностей. Реализует поэтапный подход: статический анализ (Stage1), корреляционный анализ сторонними инструментами (Stage3) с графическим интерфейсом, воспроизводимыми артефактами и структурированными отчётами.
